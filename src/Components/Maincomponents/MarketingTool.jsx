    ...
    <div>
      <div className="pageHeading">
        <div className="text-center" style={{ paddingTop: "170px" }}>
          ...
          <h4 className="text-white">Home ● Marketing Tool</h4>
        </div>
      </div>
        ...
        <div className=" px-lg-0">
          ...
          >
            <div className="card-body p-5">
              <div className="row g-5 mx-lg-0">
                <div
                  className="col-lg-12 col-md-12 wow  fadeInLeft"
                  data-wow-delay="0.1s"
                >
                  <div className="d-flex">
                    <i className="fa-solid fa-bullhorn fa-3x" />
                    <h4 className="text-primary ms-3 mt-2">Sell on Zentix</h4>
                  </div>

                  <h2 className="mt-3">Online Buying Website in Pakistan</h2>
                  <p className="mt-2">
                    As more and more people are trying to enter the business side of the world, the trend to start a side business in Pakistan is really picking up. People have now become interested in different ways of starting a small business in Pakistan. One of the most sought out options is to sell online in Pakistan. Zentix is known to be the best online-selling website in Pakistan. If you want to start Apna Karobaar with a reliable organization to back you, then the Zentix seller center is the best way to go about it. All you’ve to do is go through the Zentix seller account registration process that’s available on Zentix.asia, and you’re all set to sell on Zentix
                  </p>
                  <h2 className="mt-3">Become a Zentix Seller in Pakistan</h2>
                  <p className="mt-3">
                    If you want to start Apna Karobar and become part of a renowned online selling website in Pakistan, then zentix.asia is the place for you. With the zentix seller center, you can set up an zentix seller account and start making online sales in Pakistan! If you’re confused about the process, or how to sell on zentix, the rest is easy! The process of becoming an zentix seller is very simple. How to sell products online in Pakistan with Zentix? Three simple steps – register and list your products, receive orders, and sell across Pakistan, get payments and grow your business. For details on the process, just log on to Zentix.asia and check the sell-on Zentix page. <br /> <br />
                    Is it worth it to sell on zentix.asia? Absolutely!! With the zentix seller account, you get to reach millions of customers. In addition, zentix helps your business by assisting with fast and reliable shipping, professional services to help you, no listing fee, fast and reliable shipping, secure and timely payment, and so much more!
          ...
          >
            <div className="card-body p-5">
              <div className="row g-5 mx-lg-0">
                <div
                  className="col-lg-12 col-md-12 wow  fadeInRight"
                  data-wow-delay="0.1s"
                >
                  <div className="d-flex">
                    <i className="fa-solid fa-bullhorn fa-3x" />
                    <h4 className="text-primary ms-3 mt-2">
                      Affiliate Program
                    </h4>
                  </div>

                  <h1 className="mt-3" style={{ fontSize: '80px' }}>Affiliate Agreement</h1>
                  <p className="mt-2">
                    ...
                    The agreement, by clicking the “I Accept” button, and the Parties hereby agree, acknowledge, and accept that clicking such button shall instantly form a valid, and effective, and legally binding agreement for good consideration between the Parties.
                  ...
                  <h1 className="mt-3">1. DEFINITIONS </h1>
                  <p className="mt-2">
                    1.1 Advertising Material shall mean any advertising materials provided by the Company to the Affiliate, to be published by the Affiliate on the Affiliate’s Accounts solely to conduct the Promotion of the Channels, following the terms and conditions herein.                    <br /> <br />
                    1.2 “Affiliate” or “You” shall have the meaning given to the term in the Preamble above (i.e. the first Party named above, who shall be engaged for the purpose of, and authorized by the Company to promote the Channels on the terms and conditions of this Agreement).  <br /> <br />
                    ...
                    <br /> <br />
                    1.5 “Channels” shall mean the online marketplace operating under the style and name of ‘Zentix’, collectively through the (1) mobile application of the same name and (2) the web portals located at
                    <br /> <br />
                    ...
                    <br /> <br />
                    1.10 FBR Tax paid Company Pakistan limited  ,A company established under the laws of Pakistan with its registered Bhatta Chowk Nadrabad Street #1 Lahore cantt
                    <br /> <br />
                    ...
                    <br /> <br />
                    1.19 “Returns and Refunds Policy” shall mean the applicable Company policies which govern the procedure for returns and refunds of Products by Customers on the relevant Channels located at the Returns and Refunds Policy of Pakistan.
                    <br /> <br />
                  ...
                  <h1 className="mt-3">2. APPOINTMENT </h1>
                  <p className="mt-2">
                    ...
                    <br /> <br />
                    2.3 The Channels within the Territory will be covered non-exclusively by the Affiliate and the Company is free to engage other affiliates to provide similar services to the Promotion with the Territory.
                    <br /> <br />
                  </p>

                  <h1 className="mt-3">3. COMPENSATION </h1>
                  <p className="mt-2">
                    ...
                    <br /> <br />
                    3.2 The Parties hereby agree, acknowledge, and confirm that Commission shall not be payable against Net Sales of any Products (a) which were subsequently returned and/or refunded following the Company’s Returns & Refunds Policy; (b) against which there was a Chargeback; (c) which were part of a transaction against which any form of fraudulent activity has been suspected or found by the Company, (d) where the order transaction was canceled by the Customer after placing it; (e) where the Customer purchased the Product with the intention of reselling it; and (f) where the order was linked to the Affiliate’s conduct of any of the prohibited actions specified in Clause 7.6.1-7.6.15 hereunder (hereinafter collectively referred to as “Commission Exemptions”).
                    <br /> <br />
                    ...
                    <br /> <br />
                    3.4.4 For Commissions that are linked to any breach of the Affiliates obligations or representations under this Agreement;
                    <br /> <br />
                  ...
                  <p className="mt-2">
                    ...
                    <br /> <br />
                    4.2.3 Cookies dropped for order tracking of Products by Customers under Clause 4.2.1 shall be valid and available for 7 days thereafter.
                    <br /> <br />
                  ...
                  <h1 className="mt-3">5. RELATIONSHIP OF COMPANY AND AFFILIATE </h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">6. CONFIDENTIAL INFORMATION </h1>
                  <p className="mt-2">
                    6.1 Unless otherwise specified in the Agreement, all information exchanged during the course of the Agreement (“Confidential Information”) shall be regarded as confidential between the Parties and shall not be disclosed to any unauthorized person or used by the recipient other than for the purpose to which it relates. Any authorized disclosure to another person(s) shall be on the same terms as to confidentiality as contained in this clause. Parties hereby agree to make available Confidential Information only to those of their employees who need to have access to it for this Agreement and to obligate such employees correspondingly to the extent legally permissible.
                    <br /> <br />
                    6.2 If for this Agreement, a Party discloses any Confidential Information to its employees, it shall notify such employees of the confidential nature thereof and make all necessary efforts and take all precautions to bind such employees to keep the Confidential Information strictly confidential.
                    <br /> <br />
                    6.3 During and after the tenure of this Agreement if any Confidential Information is received by a Party under or under this Agreement the same shall be maintained in the strictest of confidence and trust.
                    ...
                    a. To comply with the mandatory provisions of applicable law or the rules of any recognized jurisdiction;
                    <br /> <br />
                    c. For any arbitration or legal proceedings arising from this Agreement; and
                    <br /> <br />
                  ...
                  <h1 className="mt-3">7. AFFILIATE RESPONSIBILITIES AND PROHIBITIONS </h1>
                  <p className="mt-2">
                    7.1 The Affiliate shall ensure that all individual representatives, personnel, staff of the Affiliate that is involved in the Affiliate’s performance of its obligations under this Agreement, have the requisite access to any equipment and amenities required to enable the Affiliate to perform its obligations under this Agreement (and that the Company shall not be responsible for providing the same). The Affiliate will diligently devote its time and efforts towards the selling of the Products.
                    <br /> <br />
                    7.2 The Affiliate shall conduct all of its performance of its obligations under this Agreement, in its own name and such manner as it may see fit. The Affiliate shall pay all expenses of its office and activities and will be responsible for the acts and expenses of its personnel/staff/representatives.
                    <br /> <br />
                    7.4 The Affiliate shall abide by Company’s policies and communicate the same to the Customers.                    <br /> <br />
                    7.5 The Affiliate hereby represents, warrants, and covenants that:                    <br /> <br />
                    7.5.1 it has full corporate power and authority to enter into this Agreement;                    <br /> <br />
                    7.5.2 it will not, under entering into and performing this Agreement, be in violation of any contractual obligation, it owes to a third party or the company under any other agreement, or any term or provision of any judgment or decree to which it is a party or by which it is bound, nor under any the contractual or legal obligation which shall supersede any of the Affiliate’s obligations under this
                    Agreement;
                    <br /> <br />
                    ...
                    <br /> <br />
                    7.6.2 bid for any search engine placement/optimization/marketing using the term “Zentix”, “Zentix.asia”, “Shop”, “shop.com” or any variation or misspelling of the terms “Zentix” or “Shop”.
                  ...
                  <h1 className="mt-3">8. COMPANY RESPONSIBILITIES AND LIMITATIONS OF LIABILITY. </h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">9. INTELLECTUAL PROPERTY RIGHTS  </h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">10. INDEMNIFICATION.  </h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">11. TERM AND TERMINATION.  </h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">12. ASSIGNMENT</h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">13. WAIVER</h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">14. MODIFICATIONS</h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">15. FURTHER ACTIONS</h1>
                  <p className="mt-2">
                    Each Party shall, without further consideration, execute and deliver such additional documents and instruments and perform all such other and further actions as may be necessary or reasonably requested to carry out the purposes and intents of this Agreement.
                    <br /> <br />
                  ...
                  <h1 className="mt-3">16. APPLICABLE LAW</h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">17. SEVERABILITY.</h1>
                  <p className="mt-2">
                  ...
                  <h1 className="mt-3">19. PARAGRAPH HEADINGS.</h1>
                  <p className="mt-2">
                    All headings set for in this Agreement are intended for convenience only and shall not control or affect the meaning, construction, or effect of this Agreement or any of the provisions thereof.        <br /> <br />
                  ...
                  <h1 className="mt-3">21. ATTORNEY’S FEES.</h1>
                  <p className="mt-2">
